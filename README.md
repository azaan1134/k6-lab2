...
results/run_stages.png - stages ашигласан үр дүн
...
**SLO тооцоо:** baseline p95 (2.43s) × 1.5 = **3645ms**. Энэ коэффициентийг сонгосон шалтгаан нь энгийн ачааллаас дунджаар 50%-иар удаан хариу өгөхийг зөвшөөрөх боловч цаашид систем хэт удаашрахаас сэргийлэх зорилготой.
 
```javascript
thresholds: {
  http_req_duration: ['p(95)<3645'],
